<template>
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input @clear="getGoodsList" placeholder="请输入内容" :clearable="true" v-model="queryInfo.query">
      ...
      <el-table :data="goodsList" border stripe>
        ...
        <el-table-column label="操作" width="130px">
          <template slot-scope="scope">
            ...
            <el-button icon="el-icon-delete" type="danger" size="mini" @click="removeById(scope.row)"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页区域 -->
